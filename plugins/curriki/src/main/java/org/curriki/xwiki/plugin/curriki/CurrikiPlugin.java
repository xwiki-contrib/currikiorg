...
public class CurrikiPlugin extends XWikiDefaultPlugin implements XWikiPluginInterface, XWikiDocChangeNotificationInterface {
    ...
    private static Set<String> publicConfigNames = new TreeSet(Arrays.asList("hostname", "GA", "addthis", "standardstab", "mediahost", "jsLibs", "globalDebug","appserverHost", "mediajwplayerkey", "geometryHome", "CDN", "CDNsemiStatic", "attachmentsCDNbaseURL", "baseURL"));
