/* ATTENTION !!!
   Remove this file once the XWiki JS events are fired properly
*/
...
XWiki.widgets.LiveTable = Class.create({
  ...
  { 
    ...
    var msg = "<strong>" + off + "</strong> - <strong>" + f + "</strong>" + _('platform.livetable.paginationResultsOf') + " <strong>" + this.totalRows + "</strong>";
    msg = msg.toLowerCase();

    this.limitsDisplay.innerHTML = _('platform.livetable.paginationResults') + msg;
    this.clearDisplay();
...
// Start Curriki
// There is no 'xwiki:dom:loading' event, so we have to listen to a more generic event
