Ext.ns("Curriki.module.review");Curriki.module.review.validateCRS=function(d,j,a){var b=Ext.select('input[type="radio"][name='+d+"]").elements;
var e=Ext.select('input[type="radio"][name='+j+"]").elements;var h=Ext.select('input[type="radio"][name='+a+"]").elements;
...
var g=Ext.select('input[type="radio"][name='+j+'][value="0"]').first().dom;var c=Ext.select('input[type="radio"][name='+a+'][value="0"]').first().dom;
