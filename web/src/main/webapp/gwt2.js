...
var addExistingResourceResource;
function addExistingResource2(resource) {
   addExistingResourceResource = resource;
   addExistingResource3();
}
...
var addFileToCollectionCollection;
function addFileToCollection2(collection) {
   addFileToCollectionCollection = collection;
   addFileToCollection3();
}
...
var createCollectionSpace;
var createCollectionPageName;
var createCollectionPageTitle;
function createCollection2(space, pageName, pageTitle) {
   createCollectionSpace = space;
   createCollectionPageName = pageName;
   createCollectionPageTitle = pageTitle;
   createCollection3();
}
...
var addResourceToCollectionCollection;
function addResourceToCollection2(collection) {
    addResourceToCollectionCollection = collection;
    addResourceToCollection3();
}
