...
public class VidiTalkUploadDialog extends ModalDialog {
    ...
    public void init(){
        ...
        XWikiGWTPanelLoader.loadWikiPage(Constants.DIALOG_ADD_VIDITALK_VIDEO, text);
    ...
    public native void addJSCallback(VidiTalkUploadDialog x) /*-{
        $wnd.setViditalkVideoId = function(videoId) {
